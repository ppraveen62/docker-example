...
##COPY --from=build /usr/src/app/target/iam-user-1.0-SNAPSHOT.jar /usr/app/iam-user-1.0-SNAPSHOT.jar
##EXPOSE 8080
#
##ENTRYPOINT [ "java", "org.springframework.boot.loader.JarLauncher" ]
##- ENTRYPOINT [ "java", "org.springframework.boot.loader.launch.JarLauncher" ]
#ENTRYPOINT [ "java", "-Dspring.profiles.active=postgres", "org.springframework.boot.loader.launch.JarLauncher" ]
##ENTRYPOINT ["java","-jar","/usr/app/iam-user-1.0-SNAPSHOT.jar"]
...
# Create a separate stage for extracting the application into layers
FROM openjdk:8-jdk-alpine AS extract

WORKDIR /app

#COPY --from=build /usr/src/app/target/dependency/ ./
